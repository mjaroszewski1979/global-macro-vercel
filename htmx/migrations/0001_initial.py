# Generated by Django 4.0.4 on 2022-06-28 19:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='htmx.car')),
        ...
        migrations.AddField(
            model_name='car',
            name='users',
            field=models.ManyToManyField(related_name='cars', through='htmx.UserCars', to=settings.AUTH_USER_MODEL),
        ),
    ]
